...
StyledRect {
    ...
    SearchBar {
        ...
        placeholderText: Tr.tr("HEX, RGB, HSL, CMYK, or OKLCH")
    ...
    StyledText {
        ...
        text: Tr.tr("Enter a valid HEX, RGB(A), HSL(A), CMYK, or OKLCH colour")
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    FormatCard {
                        Layout.fillWidth: true
                        Layout.preferredWidth: (formats.width - formats.columnSpacing) / 2
                        formatName: root.alpha < 0.9995 ? Tr.tr("RGBA") : Tr.tr("RGB")
                    ...
                    FormatCard {
                        Layout.fillWidth: true
                        Layout.preferredWidth: (formats.width - formats.columnSpacing) / 2
                        formatName: root.alpha < 0.9995 ? Tr.tr("HSLA") : Tr.tr("HSL")
