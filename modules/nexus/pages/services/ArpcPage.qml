...
PageBase {
    ...
    ColumnLayout {
        ...
        SectionHeader {
            first: true
            text: Tr.tr("Broadcast settings")
        }

        ToggleRow {
            Layout.fillWidth: true
            first: true
            text: Tr.tr("Enable rich presence")
            subtext: Tr.tr("Broadcast custom presence to Discord")
        ...
        ToggleRow {
            ...
            Layout.fillWidth: true
            text: Tr.tr("Auto-detect Steam games")
            subtext: Tr.tr("Automatically broadcast running Steam games")
        ...
        ToggleRow {
            ...
            Layout.fillWidth: true
            last: true
            text: Tr.tr("Broadcast Caelestia info")
            subtext: Tr.tr("Broadcast shell uptime and system info")
            checked: GlobalConfig.services.discordArpc.caelestiaInfo
            onToggled: GlobalConfig.services.discordArpc.caelestiaInfo = checked
        }

        SectionHeader {
            text: Tr.tr("SteamGridDB integration")
        }
        ...
        Item {
            ...
            RowLayout {
                ...
                Column {
                    ...
                    StyledText {
                        text: Tr.tr("SteamGridDB API Key")
                        font: Tokens.font.body.small
                        elide: Text.ElideRight
                    }

                    StyledText {
                        text: Tr.tr("Used to fetch game icons for Steam games")
        ...
        SectionHeader {
            text: Tr.tr("Target windows picker")
        }
        ...
        AutoEnableRow {
            ...
            last: true
            icon: "touch_app"
            label: Tr.tr("Pick from running windows")
            status: Tr.tr("Select an open window to add to ARPC")
        ...
        AutoEnableRow {
            ...
            last: true
            icon: "visibility_off"
            label: Tr.tr("Hide a running Steam game")
            status: Tr.tr("Select an open Steam game to prevent it from broadcasting")
            onSelected: windowClass => {
        ...
        SectionHeader {
            text: Tr.tr("Manual custom presence")
        }

        ToggleRow {
            first: true
            last: true
            text: Tr.tr("Enable manual override")
            subtext: Tr.tr("Force broadcast this custom presence and ignore all other apps")
